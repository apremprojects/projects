...
Pi->Microcontroller -> The Pi sends velocity setpoints every 30-50ms to the robot, telling it to set each wheel to a certain velocity for a certain amount of time.  
